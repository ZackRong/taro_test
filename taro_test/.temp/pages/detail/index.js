  ...
  render() {
    ...
    return <View className={prefixCls}>
        ...
        {loading ? null : <View>
              ...
              <BasicInfo creatorAvatarUrl={creatorAvatarUrl} creatorNickName={creatorNickName} createTime={createTime} />
              <DetailContent content={content} attachments={attachments} embeddedJson={embeddedJson} />
            </View>}
      </View>;
  }
}
