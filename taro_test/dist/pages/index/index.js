...
var Index = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Index() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Index.__proto__ || Object.getPrototypeOf(Index)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["loading", "announcementDTOs"], _this.config = {
      ...
      (0, _index3.callApi)({
        ...
        success: function success(response) {
          var _ref2 = response || {},
              ...
              announcementDTOs = _ref2$announcementDTO === undefined ? [] : _ref2$announcementDTO;
